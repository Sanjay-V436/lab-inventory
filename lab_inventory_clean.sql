...
\restrict se88u4YMOITdAaKBEff74GNlJwTjJf4xmduGeJysPnw81aTjdhXe06bm7DE16Rv
...
ALTER TABLE IF EXISTS ONLY public.returns DROP CONSTRAINT IF EXISTS returns_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.return_items DROP CONSTRAINT IF EXISTS return_items_return_id_fkey;
ALTER TABLE IF EXISTS ONLY public.return_items DROP CONSTRAINT IF EXISTS return_items_request_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.request_items DROP CONSTRAINT IF EXISTS request_items_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.request_items DROP CONSTRAINT IF EXISTS request_items_component_id_fkey;
ALTER TABLE IF EXISTS ONLY public.purchases DROP CONSTRAINT IF EXISTS purchases_component_id_fkey;
ALTER TABLE IF EXISTS ONLY public.components DROP CONSTRAINT IF EXISTS components_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.returns DROP CONSTRAINT IF EXISTS returns_request_id_key;
...
ALTER TABLE IF EXISTS ONLY public.requests DROP CONSTRAINT IF EXISTS requests_ref_id_key;
...
--
-- Name: requests requests_ref_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: returns returns_request_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: components components_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: purchases purchases_component_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: request_items request_items_component_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: return_items return_items_request_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: returns returns_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict se88u4YMOITdAaKBEff74GNlJwTjJf4xmduGeJysPnw81aTjdhXe06bm7DE16Rv
